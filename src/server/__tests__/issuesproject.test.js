...
before(done => {
  ...
  mongoose
    ...
    .then(() => {
      ...
      testcontentproject
        .findOneAndRemove({title:"testproject"})
        .then(() => {
          done()
        })
        .catch(err => {
  ...
  it('should return array of stored projects', done => {
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.have.property('data').to.be.lengthOf(5)
        done()
      })
  })
})
describe('/POST new project without params', () => {
...
describe('/POST new project', () => {
  it('should allow acreating a new project', done => {
    chai
      .request(server)
      .post('/api/issues/projects')
...
describe('/POST project already added', () => {
  ...
  it('should allow deletion of a new project', done => {
    chai
      ...
      .end((err, res) => {
        ...
        res.should.have.status(200)
        res.body.should.have.property('message').eql(`project ${projectidentifier} deleted`)
